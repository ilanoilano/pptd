...
def pdb_to_pdbqt_obabel(input_pdb: Path, output_pdbqt: Path) -> bool:
    """
    使用 OpenBabel 将 PDB 转换为 PDBQT
    
    修复：使用 obabel 计算 Gasteiger 电荷，不再手写 PDBQT
    ...
    try:
        ...
        print(f"✓ PDBQT 生成成功: {output_pdbqt}")
